      ...
      <div className="px-8">
        <section className="mt-8">
          <Paragraph>
            ...
            톱니바퀴의 모습과 닮았습니다. 우리는 구조화된 규칙 속에서 맞물리며,
            새로운 에너지를 만들어냅니다. 큐시즘은 이러한 세 파트를 존중하며 더
            나은 미래를 위한 서비스 제작을 위해 나아가고 있습니다.
          </Paragraph>
          <Paragraph className="mt-6">
            세 파트는 각자의 위치에 존재하며 서로 다른 모습으로 역할합니다.
            기획자는 현상을 다각도로 바라보고 새로운 질문을 던지며 서비스를
            제안합니다. 디자이너는 사용자를 고려해 보다 편리한 흐름으로 실제하는
            형태를 만듭니다. 개발자는 서비스가 작동하고 사용자에게 전달될 수
            있도록 구현합니다. 새로운 에너지를 만들어갈 큐밀리들을 응원하며,
            engage your energy.
          </Paragraph>
        </section>
        <section className="mt-12">
          ...
          {placeMapList.map((placeMap, index) => (
            <div key={index}>
              ...
              <div className="mt-4">
                <Image {...placeMap.image} className="mx-auto" />
              </div>
            </div>
          ))}
        </section>
